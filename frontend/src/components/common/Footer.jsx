...
const Footer = () => {
  return (
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-6 lg:px-12 py-10">
        {/* Newsletter Section */}
        <div>
        ...
        <div className="ml-10">
          ...
          <p className="flex items-center text-gray-700">
            <FiPhoneCall className="mr-2" /> 0123-456-789
          </p>
        </div>
      </div>

      {/* Footer Bottom */}
      <div className="container mx-auto mt-12 px-4 lg:px-8 border-t border-gray-300 pt-6 text-center">
