...
const EditProductPage = () => {
  ...
  const [productData, setProductData] = useState({
    ...
    collections: "",
    material: "",
    gender: "", // renamed from "genders" if that's what your API expects
    images: [],
  });
  ...
  const handleImageUpload = async (e) => {
    ...
    const formData = new FormData(); // corrected constructor
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Ensure you pass the correct product id and the updated data to your thunk
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <input
            type="text"
            name="sizes"
            value={productData.sizes.join(", ").toUpperCase()}
            onChange={(e) => {
